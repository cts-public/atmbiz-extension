...
public class AtmbizRestServices {
     ...
     * If an API key is provided, it filters the terminals that share the same Operators sample website API Access.
     *
     * @param oswApiKey The API key for a specific Operators sample website API Access. Cannot be null.
     * @return a list of terminals in JSON format, or an error message.
     */
    @GET
    @Path("/terminals")
    @Produces(MediaType.APPLICATION_JSON)
    public Response terminals(@HeaderParam("OSW_API_KEY") String oswApiKey) {
    ...
    /**
     * Method helps collect terminals with the same Operators sample website API Access in CAS
     *
     * @param iApiAccess - Operators sample website API Access
     * @return List<AtmbizTerminal> - a list of terminals that have the same Operators sample website API Access as the provided key.
     */
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response sellCrypto(AtmbizSellCryptoRequest requestObject, @HeaderParam("X-SIGNATURE") String hmac,  @HeaderParam("OSW_API_KEY") String oswApiKey) {
        // Validate if serialNumber in request object is valid against given api_key
        boolean isValidSerialNumber = validateSerialNumber(oswApiKey, requestObject.getSerialNumber());
